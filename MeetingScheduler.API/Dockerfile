...
RUN dotnet build "./MeetingScheduler.API.csproj" -c $BUILD_CONFIGURATION -o /app/build

# Esta fase é usada para publicar o projeto de serviço a ser copiado para a fase final
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./MeetingScheduler.API.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
